...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <div
        class="sc-furvIG LLJbN"
      >
        <div
          class="sc-pVTma gwsepG"
        >
          <div
            class="sc-eCImvq sc-jRQAMF sc-jrQzUz bvbNmj hCaNlo CSUIz"
          >
            <h2
              class="sc-bdvvaa sc-hKwCoD gCjFFD iBLUxr"
              color="text"
            >
              Connect to a wallet
            </h2>
          ...
          <button
            ...
            class="sc-gKckTs byTExP sc-iCfLBT jbGVuG"
            scale="md"
          >
            <svg
              class="sc-dkPtyc jAVuec"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
        ...
        <div
          class="sc-eCImvq sc-jRQAMF hBzZsF dEhKxM"
        >
          <button
            class="sc-gKckTs OFyby"
          ...
          >
            <div
              class="sc-bdvvaa bbRFty"
              color="text"
            >
              Metamask
            </div>
            <svg
              class="sc-dkPtyc eXwzkv"
              color="text"
              viewBox="0 0 96 96"
              width="32px"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            class="sc-bdvvaa sc-gsDJrp ienHcU iZzBHB sc-crHlIS leExkG"
            color="primary"
            href="https://docs.archerswap.com"
            rel="noreferrer noopener"
            target="_blank"
          >
            <svg
              class="sc-dkPtyc iCiNAM"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
              xmlns="http://www.w3.org/2000/svg"
    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          <div
            class="sc-eCImvq sc-jRQAMF kTcFfP hCaNlo"
          >
            <a
              class="sc-bdvvaa sc-gsDJrp htqzEr iZzBHB"
              color="primary"
              href="https://scan.coredao.org/address/0xb218C5D6aF1F979aC42BC68d98A5A0D796C6aB01"
              rel="noreferrer noopener"
              target="_blank"
            >
              View on Core Scan
            ...
            <div
              class="sc-bdvvaa sc-egiSv cftLDN bfEOkl"
              color="text"
              role="button"
            >
              Copy Address
          ...
          <div
            class="sc-eCImvq sc-jRQAMF bvbNmj ipZiuQ"
          >
            <button
              class="sc-gKckTs buNZhN"
              scale="sm"
            >
              Logout
            </button>
